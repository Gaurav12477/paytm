export default function ButtonMain() {
    return (
        ...
        <div className="flex flex-row bg-black cursor-pointer group hover:bg-white hover:outline hover:text-black 
        sm:w-fit w-1/2 text-white p-2 px-3 rounded-full transition-all duration-100 ease-in-out">
        <div className="font-bold text-[9px] sm:text-lg">
          Download Paytm App
        </div>
        <div className="flex flex-row justify-center items-center ml-2">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" className="h-4 w-4 sm:h-6 sm:w-6 fill-white group-hover:fill-black " viewBox="0 0 30 30">
